...
// Verifica se está logado - Lógica simples com IF/ELSE completo
...
// Busca o animal colocando a variável direto na string SQL (Jeito simples)
$sql = "SELECT * FROM animais WHERE id = $animal_id";
$result = mysqli_query($conexao, $sql);
$animal = mysqli_fetch_assoc($result);

// Busca as raças para preencher o select
...
<head>
    ...
    <style>
        /* Estrutura para o footer ficar sempre embaixo */
        html, body { height: 100%; margin: 0; }
        body { display: flex; flex-direction: column; background-color: #ffffff; font-family: Arial, sans-serif; }
        .conteudo-principal { flex: 1; padding-bottom: 50px; }
...
<script>
    // Pega as coordenadas vindas do banco pelo PHP
    ...
    // Quando terminar de arrastar, atualiza os inputs escondidos
